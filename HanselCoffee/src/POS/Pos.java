...
public class Pos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("SHOES FOR SELL");

        jLabel12.setText("###");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "NIKE ", "ADIDAS", "VANS", "PUMA", "JORDAN" }));
    ...
    public void definePrice(String pprodut){
         if(product.equals("NIKE")){
             setPrice(5999d);
        }
         else if(product.equals("ADIDAS")){
             setPrice(4999d);
         }
         else if(product.equals("VANS")){
             setPrice(5599d);
         }
         else if(product.equals("PUMA")){
             setPrice(3399d);
         }
         else if(product.equals("JORDAN")){
             setPrice(4599d);
         }
